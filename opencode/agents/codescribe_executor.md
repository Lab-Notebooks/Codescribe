...
model: alcf_metis/gpt-oss-20b #argo_proxy/argo:gpt-5-mini
...
## Nuances
1. When you are asked to do a fresh run after completing the current run politely ask to switch to `Codescribe.Router`
